...
function getStore(): WorkflowConfig {
  if (!globalStore.__workflowConfig) {
    globalStore.__workflowConfig = structuredClone(defaultWorkflowConfig);
  }

  normalizeWorkflowConfig(globalStore.__workflowConfig);
  syncStepThresholds(globalStore.__workflowConfig);
  return globalStore.__workflowConfig;
}
...
export function updateWorkflowConfig(config: WorkflowConfig): WorkflowConfig {
  globalStore.__workflowConfig = structuredClone(config);
  normalizeWorkflowConfig(globalStore.__workflowConfig);
  syncStepThresholds(globalStore.__workflowConfig);
  return getWorkflowConfig();
}

function normalizeWorkflowConfig(config: WorkflowConfig): void {
...
function syncStepThresholds(config: WorkflowConfig): void {
